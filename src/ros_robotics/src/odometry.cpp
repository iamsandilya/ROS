...
double DistancePerCount = (3.14159265 * 0.1)/842; //the wheel diameter is 0.1m
...
void WheelCallback(const geometry_msgs::Vector3::ConstPtr& ticks)
{
 ...
 delta_th = (double)(deltaRight-deltaLeft)*DistancePerCount/0.58f; //Distance between the two wheels is 0.58m
